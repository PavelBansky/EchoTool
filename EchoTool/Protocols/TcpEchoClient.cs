...
namespace EchoTool.Protocols
{
    ...
    public class TcpEchoClient : IDisposable
    {
        ...
        public TcpEchoClient(string hostName, int remotePort, int localPort) : this()
        {
            HostName = hostName;
        ...
        public TcpEchoClient(string hostName, int remotePort) : this(hostName, remotePort, 0)
        {
        }
        #endregion
        ...
        private bool GetHostnameEndPoint(out IPEndPoint serverEndPoint)
        {
            ...
            try
            {
                ...
                foreach (var ipAddress in addressList.Where(ipAddress => ipAddress.AddressFamily == AddressFamily.InterNetwork))
                {
